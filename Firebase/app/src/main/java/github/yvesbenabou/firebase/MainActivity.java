...
//    }
    ...
    //CalendarFetcher.rooms.setSalle(new Salle("4205", github.yvesbenabou.firebase.Status.FREE, " ", findViewById(R.id.s4205)));
    ...
    //CalendarFetcher.rooms.setSalle(new Salle("4409", github.yvesbenabou.firebase.Status.FREE, " ", findViewById(R.id.s4409)));
