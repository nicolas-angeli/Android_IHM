...
public class CalendarFetcher {
    ...
    public static void show_4() {
        ...
        CalendarFetcher.rooms.getSalle("2407").show();
        ...
        CalendarFetcher.rooms.getSalle("4409").show();
    ...
    public static void show_0() {
        ...
        CalendarFetcher.rooms.getSalle("4005").show();
    ...
    public static void hide_1() {
        ...
        CalendarFetcher.rooms.getSalle("0160").hide();
        CalendarFetcher.rooms.getSalle("0161").hide();
